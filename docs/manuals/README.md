...
이 폴더는 코드가 생기기 전부터 유지하는 사용자 교육 기준이다. 예시는 **목표 인터페이스**이며,
현재 reference workflow가 제품 API 전체를 구현했다는 뜻이 아니다.

## 읽는 순서

1. [Excalibur 비유와 사람 권한](00-excalibur-concept.md)
...
| 독자 | 먼저 볼 문서 | 다음 행동 |
|---|---|---|
| 과제 수행자 | 6컷 튜토리얼 | dossier 증거와 locator 준비 |
