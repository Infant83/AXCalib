...
- 완료 품질 slice: GOAL alignment, public API/script usability와 EX-01~12 example self-check
...
1. Evaluation Owner가 공식 rubric과 gold fixture를 승인하면 WP-03.Q2 report benchmark를 진행한다.
