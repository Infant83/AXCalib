...
- 문서 checkpoint: WP-00.D2 GitHub/GitLab portable Wiki source/export local contract
...
- local Wiki export 성공을 실제 GitHub/GitLab Wiki 초기화·runner·credential·publication 성공으로 간주하는 것
