...
|---|---|---|---|
| P0 Planning | 명명·목표·작업계약·설계 정렬 | AGENTS, GOAL, DESIGN, WORK_SPEC v0.3 | 문서 간 충돌 없음 |
| P1 Harness | 실행 뼈대와 reference workflow | pyproject, prep.ps1, harness, state/decision/risk, synthetic flow | 구현 완료, G1 owner review |
...
- [ ] Pipeline kernel과 첫 dossier.freeze working script 구현
- [ ] G1 Harness baseline owner review
