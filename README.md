...
reference**, **WP-01.R1.2 Library MVP/Alpha local 검증 완료**, **WP-06.I1 runtime API와 WP-06.I2a/I2b
principal-bound project·education API local Alpha** 단계다. Python Library, local pipeline,
