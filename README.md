...
reference**, **WP-01.R1.2 Library MVP/Alpha local 검증 완료** 단계다. Python Library, local pipeline,
...
- Vector DB/Qdrant, 실제 embedding 품질, multi-model calibration, full product CLI, API/Web,
  report/outbox producer transaction과 distributed worker는 아직 구현되지 않았다.
