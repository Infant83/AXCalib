...
단계다. Python Library, live Case status/summary, local pipeline,
...
실행한다. 긴 단일 pytest 대신 unit, `integration-core/eval/ops`, contract를 독립 process로 실행한다.
...
인증 결과가 아니다. 정상·오류·경계 EX-01~EX-12 전체 명령은
...
1. Evaluation Owner가 WP-03.Q2에 사용할 공식 registration/completion rubric, threshold와 승인된
   비식별 gold fixture를 제공한다.
2. `WP-00.Q1`의 Case read facade, GOAL/script trace와 EX-01~12 local 표준화 checkpoint를 회귀
